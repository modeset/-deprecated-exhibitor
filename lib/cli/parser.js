...
// Concatenates a configuration object of markdown files and `@includes` into a single buffer
...
// Retrieve the global options from the top of the configuration file
...
// Retrieve options associated with particular settings from the configuration file
...
// The public method to start parsing of the configuration file
...
Parser.prototype.concat = function(sections) {
  ...
  sections.forEach(function (section) {
    // Add in a section comment for the buffer to associate options with at compile time
...
// Return an error string when a file is not found
