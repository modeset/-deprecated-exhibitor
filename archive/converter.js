...
var Converter = module.exports = function Converter(file) {
...
Converter.prototype.convert = function() {
  ...
  return JSON.stringify(this.exhibit_data)
}

// Concatenate the sections into a single buffer
Converter.prototype.concatSections = function(sections) {
  var sections_buffer = ''
  var self = this
...
Converter.prototype.concatFiles = function(section) {
...
Converter.prototype.includeFiles = function(buffer) {
...
Converter.prototype.convertToSlides = function(html) {
  var buff = html.split('\n')
...
Converter.prototype.parseOptions = function(str) {
...
Converter.prototype.parseExtras = function(str) {
  var self = this
  var o = {}
...
Converter.prototype.getIncludeFileName = function(desc) {
...
Converter.prototype.writeToMarkdownBuffer = function(str) {
  var contents = str
  this.mkdn_buffer += contents + '\n'
}

// Look for a file first in the given directory or any of it's subdirectories
Converter.prototype.findFile = function(dir, file) {
  var self = this
  var buffer;
  var tmp;
